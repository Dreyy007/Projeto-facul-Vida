...
import { View, Text, ScrollView, StyleSheet, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, AppState } from 'react-native'
...
export default function ChatScreen() {
  ...
  async function registrarPushToken() {
    ...
    if (token) {
      await supabase.from('pacientes').update({ push_token: token }).eq('id', paciente.id)
    }
  }
